...
!----------------------------------------------------------
        ...
        module commun_modele_joint
                integer,save ::ng,nv,idiag,ncssg,nvc,nea,ncg,nwg,ncor,logspecif &
...
!------------------------------------------------------------
      ...
      subroutine jointhet(Y0,X0,Prior0,idprob0,idea0,idg0,idcor0,idxevt0 &
      ,ns0,ng0,nv0,nobs0   &
      ,nea0,ncor0 &
      ...
      integer, intent(in) :: ns0, ng0, nobs0, idiag0, nwg0, ncor0, npm0
...
!------------------------------------------------------------
      ...
      integer ::i,j,k,l,m,g,l2,m2,id,jd,jj,npm,j1,j2
      integer ::ier,nmoins
...
!------------------------------------------------------------
      ...
      use optim
      implicit none
      integer ::i,j,k,l,m,g,l2,m2,jj,npm,j1,j2
...
!         write(*,*)'VarsCore2', (Vars2(j),j=1,nea*(nea+1)/2)
 ...
 147  continue
      deallocate(VC,Corr,Vi,stat,ppi)
