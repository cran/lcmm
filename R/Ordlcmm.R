...
.Ordlcmm <-
function(fixed,mixture,random,subject,classmb,ng,idiag,nwg,data,B,convB,convL,convG,prior,maxiter,zitr,ide,call,Ydiscrete)
...
mCall$zitr<-mCall$ide<-mCall$call<-mCall$Ydiscrete<- NULL
##### ad
